...
namespace Calculator
{
    public partial class NumButton : UserControl
    {
        ...
        private void NumButton_Paint(object sender, PaintEventArgs e)
        {
            Graphics g = e.Graphics;
            g.SmoothingMode = SmoothingMode.AntiAlias;
            Color begin_color = Color.FromArgb(250, 250, 250);
            Color end_color = Color.FromArgb(240, 240, 240);
            if (state == BtState.Enter)
            {
                begin_color = Color.FromArgb(150, 250, 250, 250);
                end_color = Color.FromArgb(150, 240, 240, 240);
            }
            ...
            SolidBrush textbrush = new SolidBrush(Color.FromArgb(80, 80, 80));
