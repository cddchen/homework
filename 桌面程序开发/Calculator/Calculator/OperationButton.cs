...
{
    public partial class OperationButton : UserControl
    {
        private string text;
        ...
        private void OperationButton_Paint(object sender, PaintEventArgs e)
        {
            ...
            Color begin_color = Color.FromArgb(140, 140, 140);
            Color end_color = Color.FromArgb(100, 100, 100);
            if (state == BtState.Enter)
            {
                begin_color = Color.FromArgb(150, 140, 140, 140);
                end_color = Color.FromArgb(150, 100, 100, 100);
            }
